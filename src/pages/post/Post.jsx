...
export default function Post() {
  ...
  const GET_POST_URL = `https://backend1001.vercel.app/api/posts/read/${postId.id}/`
  ...
  if(isLoading) {
    return <div className='container'>  <img src="https://digitalsynopsis.com/wp-content/uploads/2016/06/loading-animations-preloader-gifs-ui-ux-effects-3.gif" alt="Loading" /></div>
  }
